		...
		<div class="container">
			<div class="row" style="margin-top: 30px">
				...
				<div class="input-group mb-3 col-md-6 ">
					...
					<input type="text" class="form-control" id="code" name="code" style="ime-mode:disabled" maxlength="6" placeholder="code를 입력하세요" required="true" data-parsley-error-message="사용가능한 코드가 아닙니다" data-parsley-errors-container="div[id='codeerror']">
					<button type="button" id="confirm" class="btn btn-primary" name="confirm">중복확인</button>
				</div>
				<div class="col-md-3"></div>
			</div>
			<div class="row">
			...
			<div class="row" style="margin-top: 30px">
				...
				<div class="input-group mb-3 col-md-6 ">
					...
					<input type="text" class="form-control" id="name" name="name" maxlength="20" placeholder="이름을 입력하세요" required="true" data-parsley-error-message="이름을 입력하세요" data-parsley-errors-container="div[id='nameerror']">
				</div>
				<div class="col-md-3"></div>
			</div>
			<div class="row">
			...
			<div class="row" style="margin-top: 30px">
				...
				<div class="input-group mb-3 col-md-6 ">
					...
					<input type="text" class="form-control" id="age" name="age" onkeydown='return onlyNumber(event)' onkeyup='removeChar(event)' maxlength="3" placeholder="나이를 입력하세요" required="true" data-parsley-error-message="나이를 입력하세요" data-parsley-errors-container="div[id='ageerror']">
				</div>
				<div class="col-md-3"></div>
			</div>
			<div class="row">
